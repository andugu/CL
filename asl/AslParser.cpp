...
//----------------- ComparisonRelationContext ------------------------------------------------------------------

std::vector<AslParser::ExprContext *> AslParser::ComparisonRelationContext::expr() {
  return getRuleContexts<AslParser::ExprContext>();
}

AslParser::ExprContext* AslParser::ComparisonRelationContext::expr(size_t i) {
  return getRuleContext<AslParser::ExprContext>(i);
}

tree::TerminalNode* AslParser::ComparisonRelationContext::EQUAL() {
  return getToken(AslParser::EQUAL, 0);
}

tree::TerminalNode* AslParser::ComparisonRelationContext::NOTEQUAL() {
  return getToken(AslParser::NOTEQUAL, 0);
}

tree::TerminalNode* AslParser::ComparisonRelationContext::LESS() {
  return getToken(AslParser::LESS, 0);
}

tree::TerminalNode* AslParser::ComparisonRelationContext::LESSEQUAL() {
  return getToken(AslParser::LESSEQUAL, 0);
}

tree::TerminalNode* AslParser::ComparisonRelationContext::GREATER() {
  return getToken(AslParser::GREATER, 0);
}

tree::TerminalNode* AslParser::ComparisonRelationContext::GREATEREQUAL() {
  return getToken(AslParser::GREATEREQUAL, 0);
}

AslParser::ComparisonRelationContext::ComparisonRelationContext(ExprContext *ctx) { copyFrom(ctx); }

antlrcpp::Any AslParser::ComparisonRelationContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<AslVisitor*>(visitor))
    return parserVisitor->visitComparisonRelation(this);
  else
    return visitor->visitChildren(this);
}
//----------------- AndRelationalContext ------------------------------------------------------------------

std::vector<AslParser::ExprContext *> AslParser::AndRelationalContext::expr() {
  return getRuleContexts<AslParser::ExprContext>();
}

AslParser::ExprContext* AslParser::AndRelationalContext::expr(size_t i) {
  return getRuleContext<AslParser::ExprContext>(i);
}

tree::TerminalNode* AslParser::AndRelationalContext::AND() {
  return getToken(AslParser::AND, 0);
}

AslParser::AndRelationalContext::AndRelationalContext(ExprContext *ctx) { copyFrom(ctx); }

antlrcpp::Any AslParser::AndRelationalContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<AslVisitor*>(visitor))
    return parserVisitor->visitAndRelational(this);
  else
    return visitor->visitChildren(this);
}
//----------------- CharValueContext ------------------------------------------------------------------
...
std::vector<AslParser::ExprContext *> AslParser::OrRelationalContext::expr() {
  return getRuleContexts<AslParser::ExprContext>();
}

AslParser::ExprContext* AslParser::OrRelationalContext::expr(size_t i) {
  return getRuleContext<AslParser::ExprContext>(i);
}

tree::TerminalNode* AslParser::OrRelationalContext::OR() {
  return getToken(AslParser::OR, 0);
}

AslParser::OrRelationalContext::OrRelationalContext(ExprContext *ctx) { copyFrom(ctx); }

antlrcpp::Any AslParser::OrRelationalContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<AslVisitor*>(visitor))
    return parserVisitor->visitOrRelational(this);
  else
    return visitor->visitChildren(this);
}
//----------------- FloatValueContext ------------------------------------------------------------------
...
tree::TerminalNode* AslParser::ValueContext::NOT() {
  ...
  try {
    ...
    while (alt != 2 && alt != atn::ATN::INVALID_ALT_NUMBER) {
      if (alt == 1) {
        ...
        case 3: {
          auto newContext = _tracker.createInstance<ComparisonRelationContext>(_tracker.createInstance<ExprContext>(parentContext, parentState));
          _localctx = newContext;
          pushNewRecursionContext(newContext, startState, RuleExpr);
          setState(127);
          ...
          setState(128);
          dynamic_cast<ComparisonRelationContext *>(_localctx)->op = _input->LT(1);
          _la = _input->LA(1);
          if (!((((_la & ~ 0x3fULL) == 0) &&
            ...
            dynamic_cast<ComparisonRelationContext *>(_localctx)->op = _errHandler->recoverInline(this);
          }
          else {
            _errHandler->reportMatch(this);
            consume();
        ...
        case 4: {
          auto newContext = _tracker.createInstance<AndRelationalContext>(_tracker.createInstance<ExprContext>(parentContext, parentState));
          _localctx = newContext;
          pushNewRecursionContext(newContext, startState, RuleExpr);
          setState(130);
          ...
          setState(131);
          dynamic_cast<AndRelationalContext *>(_localctx)->op = match(AslParser::AND);
          setState(132);
          expr(7);
          break;
        }
        ...
        case 5: {
          auto newContext = _tracker.createInstance<OrRelationalContext>(_tracker.createInstance<ExprContext>(parentContext, parentState));
          _localctx = newContext;
          pushNewRecursionContext(newContext, startState, RuleExpr);
          setState(133);
          ...
          setState(134);
          dynamic_cast<OrRelationalContext *>(_localctx)->op = match(AslParser::OR);
          setState(135);
          expr(6);
          break;
        }
...
AslParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x3, 0x2e, 0x92, 0x4, 0x2, 0x9, 0x2, 0x4, 0x3, 0x9, 0x3, 0x4, 0x4, 0x9, 
    ...
    0xb, 0x7a, 0xa, 0xb, 0x3, 0xb, 0x3, 0xb, 0x3, 0xb, 0x3, 0xb, 0x3, 0xb, 
    0x3, 0xb, 0x3, 0xb, 0x3, 0xb, 0x3, 0xb, 0x3, 0xb, 0x3, 0xb, 0x3, 0xb, 
    0x3, 0xb, 0x3, 0xb, 0x3, 0xb, 0x7, 0xb, 0x8b, 0xa, 0xb, 0xc, 0xb, 0xe, 
    0xb, 0x8e, 0xb, 0xb, 0x3, 0xc, 0x3, 0xc, 0x3, 0xc, 0x2, 0x3, 0x14, 0xd, 
    0x2, 0x4, 0x6, 0x8, 0xa, 0xc, 0xe, 0x10, 0x12, 0x14, 0x16, 0x2, 0x7, 
    0x3, 0x2, 0x1a, 0x1d, 0x4, 0x2, 0x10, 0x10, 0x14, 0x15, 0x3, 0x2, 0x16, 
    0x18, 0x3, 0x2, 0x14, 0x15, 0x3, 0x2, 0xa, 0xf, 0x2, 0x9b, 0x2, 0x19, 
    0x3, 0x2, 0x2, 0x2, 0x4, 0x1f, 0x3, 0x2, 0x2, 0x2, 0x6, 0x2a, 0x3, 0x2, 
    0x2, 0x2, 0x8, 0x2d, 0x3, 0x2, 0x2, 0x2, 0xa, 0x39, 0x3, 0x2, 0x2, 0x2, 
    0xc, 0x42, 0x3, 0x2, 0x2, 0x2, 0xe, 0x47, 0x3, 0x2, 0x2, 0x2, 0x10, 
    0x65, 0x3, 0x2, 0x2, 0x2, 0x12, 0x67, 0x3, 0x2, 0x2, 0x2, 0x14, 0x79, 
    0x3, 0x2, 0x2, 0x2, 0x16, 0x8f, 0x3, 0x2, 0x2, 0x2, 0x18, 0x1a, 0x5, 
    0x4, 0x3, 0x2, 0x19, 0x18, 0x3, 0x2, 0x2, 0x2, 0x1a, 0x1b, 0x3, 0x2, 
    0x2, 0x2, 0x1b, 0x19, 0x3, 0x2, 0x2, 0x2, 0x1b, 0x1c, 0x3, 0x2, 0x2, 
