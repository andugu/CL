...
public:
  ...
  enum {
    ...
    RuleType2 = 4, RuleType = 5, RuleStatements = 6, RuleStatement = 7, 
  ...
  class  Type2Context : public antlr4::ParserRuleContext {
  public:
    Type2Context(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  SingleRelationalContext : public ExprContext {
  public:
    SingleRelationalContext(ExprContext *ctx);
